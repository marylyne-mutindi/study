...
<!-- Mirrored from www.einfosoft.com/templates/admin/smart/source/dark/add_library_bootstrap.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Oct 2022 08:34:50 GMT -->
<head>
	<meta charset="utf-8" />
									...
									<form action="#" id="form_sample_1" class="form-horizontal">
										<div class="form-body">
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="coursename" placeholder="enter title"
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<select class="form-select input-height" name="sub">
											...
											<div class="form-group row">
												<label class="control-label col-md-3">Auther Name
												</label>
												<div class="col-md-5">
											...
											<div class="form-group row">
												<label class="control-label col-md-3">Publisher
												</label>
												<div class="col-md-5">
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<select class="form-select input-height" name="departmnt">
														<option value="">Select...</option>
														<option value="Category 1">Mathematics</option>
											...
											<div class="form-group row">
												<label class="control-label col-md-3">Asset Type <span class="required">
														* </span>
												</label>
												<div class="col-md-5">
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="price" placeholder="enter title"
														class="form-control input-height" /> </div>
											</div>
											<div class="form-group row">
											...
											<div class="form-group row">
												<label class="control-label col-md-3">Asset Details
												</label>
												<div class="col-md-5">
													<textarea name="address" placeholder="asset details"
