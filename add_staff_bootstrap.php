...
<!-- Mirrored from www.einfosoft.com/templates/admin/smart/source/dark/add_staff_bootstrap.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Oct 2022 08:34:54 GMT -->
<head>
	<meta charset="utf-8" />
									...
									<form action="#" id="form_sample_1" class="form-horizontal">
										<div class="form-body">
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="cnfmPwd" data-required="1"
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<select class="form-select input-height" name="department">
														...
														<option value="Category 1">Library</option>
														<option value="Category 2">Administration</option>
														<option value="Category 3">Transport</option>
														<option value="Category 4">Laboratory</option>
