				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Edit Holiday</div>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
										href="index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href="#">Holiday</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								...
								<div class="card-body row">
									<div class="col-lg-12 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text" value="christmas holiday"
												id="txttitle">
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text" id="list2"
												value="Public Holiday" readonly tabIndex="-1">
											<label for="list2" class="pull-right margin-0">
												<i class="mdl-icon-toggle__label material-icons">keyboard_arrow_down</i>
											</label>
											<label for="list2" class="mdl-textfield__label">Holiday Types</label>
											<ul data-mdl-for="list2" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
												<li class="mdl-menu__item" data-val="DE">Public Holiday</li>
												<li class="mdl-menu__item" data-val="BY">Holiday By University</li>
											</ul>
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text" value="2017-12-24"
												id="date">
											<label class="mdl-textfield__label">Holiday Start Date</label>
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
									...
									<div class="col-lg-12 p-t-20">
										<div class="mdl-textfield mdl-js-textfield txt-full-width">
											<textarea class="mdl-textfield__input" rows="4"
												id="text7">Holiday because its Christmas </textarea>
											<label class="mdl-textfield__label" for="text7">Holiday Details</label>
										</div>
									</div>
...
<!-- Mirrored from www.einfosoft.com/templates/admin/smart/source/dark/edit_holiday.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Oct 2022 08:34:54 GMT -->
</html>