...
<body
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">eCharts</div>
							</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body no-padding height-9">
									<div class="row">
										<div id="echarts_scatter" style="width:100%; height: 500px;"></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body no-padding ">
									<div class="row">
										<div id="echarts_pie" style="width:100%; height: 500px;"></div>
									</div>
								</div>
							</div>
						</div>
	...
	<!-- echart -->
	<script src="https://www.einfosoft.com/templates/admin/smart/source/assets/plugins/echarts/echarts.js"></script>
	<script src="https://www.einfosoft.com/templates/admin/smart/source/assets/js/pages/chart/echart/echart-data.js"></script>
	<!-- Common js-->
...
<!-- Mirrored from www.einfosoft.com/templates/admin/smart/source/dark/charts_echarts.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Oct 2022 08:34:56 GMT -->
</html>