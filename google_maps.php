...
<body
					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="#">Maps</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body ">
									<div class="label label-danger visible-ie8"> Not supported in Internet Explorer 8
									</div>
	...
	<script src="https://www.einfosoft.com/templates/admin/smart/source/assets/plugins/gmaps/gmaps.min.js"></script>
	<script src="https://www.einfosoft.com/templates/admin/smart/source/assets/js/pages/map/google-maps-data.js"></script>
	<!-- Common js-->
...
<!-- Mirrored from www.einfosoft.com/templates/admin/smart/source/dark/google_maps.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Oct 2022 08:34:56 GMT -->
</html>