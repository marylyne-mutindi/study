...
<!-- Mirrored from www.einfosoft.com/templates/admin/smart/source/dark/add_department.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Oct 2022 08:34:50 GMT -->
<head>
	<meta charset="utf-8" />
							...
							<div class="card-box">
								...
								<div class="card-body row">
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" id="txtDepHead">
