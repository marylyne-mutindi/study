...
<!-- Mirrored from www.einfosoft.com/templates/admin/smart/source/dark/add_department_bootstrap.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Oct 2022 08:34:50 GMT -->
<head>
	<meta charset="utf-8" />
									...
									<form action="#" id="form_sample_1" class="form-horizontal">
										<div class="form-body">
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="dpname" placeholder="enter department name"
											...
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="auther" placeholder="enter HOD name"
														class="form-control input-height" /> </div>
											</div>
											<div class="form-group row">
												<label class="control-label col-md-3">Department Start Date
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
											...
											<div class="form-group row">
												<label class="control-label col-md-3">Student Capacity
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
