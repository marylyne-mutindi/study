...
<!-- Mirrored from www.einfosoft.com/templates/admin/smart/source/dark/add_holiday_bootstrap.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Oct 2022 08:34:54 GMT -->
<head>
	<meta charset="utf-8" />
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Add Holiday</div>
							</div>
									...
									<form action="#" id="form_sample_1" class="form-horizontal">
										<div class="form-body">
											<div class="form-group row">
												...
												<div class="col-md-5">
													<input type="text" name="title" placeholder="enter holiday title"
														class="form-control input-height" />
												</div>
											</div>
											<div class="form-group row">
												<label class="control-label col-md-3">Holiday Type
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
											...
											<div class="form-group row">
												<label class="control-label col-md-3">Holiday Start Date
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
											...
											<div class="form-group row">
												<label class="control-label col-md-3">Holiday End Date
													<span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<div class="input-append date">
											...
											<div class="form-group row">
												<label class="control-label col-md-3">Holiday Details
												</label>
												<div class="col-md-5">
													<textarea name="details" placeholder="department details"
