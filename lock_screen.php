							...
							<div class="wrap-login100">
								<form class="login100-form validate-form">
									<span class="login100-form-logo">
										<img src="https://www.einfosoft.com/templates/admin/smart/source/assets/img/dp.jpg" class="imgroundcorners" alt="John Doe">
									</span>
